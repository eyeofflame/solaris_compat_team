...
public class RarePool extends BountyPool {
    ...
    public RarePool(String name, @Nullable List<ItemStack> requireItems, @Nullable List<KilledEntityData> requireEntities, List<ItemStack> list) {
